...
* init-map.el
  ...
  #+begin_src emacs-lisp :tangle ./lisp/init-map.el :mkdirp yes
    ...
    (general-def 'normal dashboard-mode-map "R" #'restore-previous-session)
    ...
    (spc-leader-def
      ...
      ;; dict
      "y" #'(youdao-dictionary-search-at-point+ :which-key "Youdao")
      )
  ...
  #+begin_src emacs-lisp :tangle ./lisp/init-dashboard.el :mkdirp yes
    ...
    (use-package dashboard
      ...
      (setq initial-buffer-choice (lambda () (get-buffer "*dashboard*"))
            dashboard-banner-logo-title "Solarion Emacs"
            ...
            dashboard-navigator-buttons '(() ;; Empty line
                                          ;; line 2
                                          ((nil "Homepage" "Browse homepage" (lambda (&rest _) (browse-url "https://github.com/wang1zhen/solarion-emacs")))
                                           (nil "Restore" "Restore previous session" (lambda (&rest _) (restore-previous-session)))
                                           (nil "Config" "Open custom file" (lambda (&rest _) (find-file (concat user-emacs-directory "solarion.org"))))
                                           (nil "Update" "Update Packages" (lambda (&rest _) (auto-package-update-now))))))
