...
* init-ui.el
  ...
  #+begin_src emacs-lisp :tangle ./lisp/init-ui.el :mkdirp yes
    ...
    (use-package modus-themes
      :init
      (setq modus-themes-italic-constructs (display-graphic-p)	;; italic is not cool in terminal mode
...
* init-ivy.el
  ...
  #+begin_src emacs-lisp :tangle ./lisp/init-ivy.el :mkdirp yes
    ...
    (use-package counsel
      ...
      :config
      (setq counsel-rg-base-command '("rg" "--max-columns" "500" "--with-filename" "--no-heading" "--line-number" "--color" "never" "--ignore-case" "%s")))
